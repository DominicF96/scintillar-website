...
import * as i18n from "@/i18n/components/web/footer.i18n";
      ...
      <div className="mx-auto max-w-[1200px] px-4">
        <div className="flex flex-col items-start w-full mb-6 md:flex-row md:justify-between">
          ...
          <ul className="flex flex-row gap-2 mb-6">
            ...
            <li>
              <Link
                href="https://discord.gg/M6QmREsCTj"
            ...
            <li>
              <Link
                href="https://github.com/scintillar-com"
            ...
            <li>
              <Link
                href="https://www.youtube.com/channel/UCaX0DcC6rY73CmHQKi5ArFg"
